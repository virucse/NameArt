...
-keepattributes EnclosingMethod, Signature, JavascriptInterface
...
-keepattributes Deprecated,LineNumberTable
...
-dontwarn  com.android.dx.cf.code.SimException.*
-keep class  com.android.dx.cf.code.SimException.**{*;}
