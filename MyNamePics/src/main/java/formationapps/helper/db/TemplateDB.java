...
public class TemplateDB extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "templatedb";

    // Contacts table name
    private static final String TABLE_TEMPLATE = "templatetb";
    ...
    public TemplateDB(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
    ...
    public long Template_insertJson(String json) {
