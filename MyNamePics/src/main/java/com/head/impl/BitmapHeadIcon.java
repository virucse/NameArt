...
public class BitmapHeadIcon extends DrawableSticker implements HeadIconEvent {
    ...
    private HeadIconEvent iconEvent;

    public BitmapHeadIcon(Drawable drawable, @Gravity int gravity) {
        super(drawable);
    ...
    public HeadIconEvent getIconEvent() {
        return iconEvent;
    }

    public void setIconEvent(HeadIconEvent iconEvent) {
