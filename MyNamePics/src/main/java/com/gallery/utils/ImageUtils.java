...
public class ImageUtils {
    ...
    static {
        ...
        DOWNLOAD_IMAGE_PATH = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) + "/formationapps/MyNamePics";
    ...
    public static File getTempMediaFile() {
        ...
        if (!(mediaStorageDir.exists() || mediaStorageDir.mkdirs())) {
            mediaStorageDir = GalleryUtil.context.getFilesDir();
        }
    ...
    public Bitmap loadBitmap(Context param1, Uri param2, int num) {
        ...
        int size = (int) ((((float) GalleryUtil.screenHeight) * 3.0f) / ((float) num));
