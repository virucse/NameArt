...
public class TextSticker extends Sticker {
    ...
    private String text;
    private CharSequence mSpannableText;
    ...
    public TextSticker setTextUnderline(boolean underline) {
    ...
    public TextSticker setTextAlign(Layout.Alignment align) {
        alignment = align;
        if (isCreative) {
            resizeCreativeText();
        } else {
    ...
    public void setCreativeText(SpannableString ss) {
        if (isCreative) {
            setText(getText());
            resizeText();
            isCreative = false;
     ...
     */
    @NonNull
    public TextSticker resizeCreativeText() {
        staticLayout = null;
        final int availableHeightPixels = textRect.height();
   ...
   /* if (targetTextSizePixels == minTextSizePixels
      ...
      if (staticLayout.getLineCount() > 0) {
        ...
        textPaint.setTextSize(targetTextSizePixels);
        staticLayout =
                new StaticLayout(mSpannableText, textPaint, textRect.width(), alignment, lineSpacingMultiplier,
                        lineSpacingExtra, true);
        isCreative = true;
        return this;
    }
