...
public class IFImageFilter extends GPUImageFilter {
    ...
    public IFImageFilter(Context context, String fragmentShaderString) {
        super(GPUImageFilter.NO_FILTER_VERTEX_SHADER, fragmentShaderString);
    ...
    public void initInputTexture() {
        if (this.mResIds != null) {
            if (this.mResIds.size() > 0) {
                runOnDraw(new C01471());
            }
            if (this.mResIds.size() > 1) {
                runOnDraw(new C01482());
            }
            if (this.mResIds.size() > 2) {
                runOnDraw(new C01493());
            }
            if (this.mResIds.size() > 3) {
                runOnDraw(new C01504());
            }
            if (this.mResIds.size() > 4) {
                runOnDraw(new C01515());
            }
        }
    }
    ...
    class C01471 implements Runnable {
        ...
        public void run() {
            Bitmap b = BitmapFactory.decodeResource(IFImageFilter.this.mContext.getResources(), ((Integer) IFImageFilter.this.mResIds.get(0)).intValue());
    ...
    class C01482 implements Runnable {
        ...
        public void run() {
            Bitmap b = BitmapFactory.decodeResource(IFImageFilter.this.mContext.getResources(), ((Integer) IFImageFilter.this.mResIds.get(1)).intValue());
    ...
    class C01493 implements Runnable {
        ...
        public void run() {
            Bitmap b = BitmapFactory.decodeResource(IFImageFilter.this.mContext.getResources(), ((Integer) IFImageFilter.this.mResIds.get(2)).intValue());
    ...
    class C01504 implements Runnable {
        ...
        public void run() {
            Bitmap b = BitmapFactory.decodeResource(IFImageFilter.this.mContext.getResources(), ((Integer) IFImageFilter.this.mResIds.get(3)).intValue());
    ...
    class C01515 implements Runnable {
        ...
        public void run() {
            Bitmap b = BitmapFactory.decodeResource(IFImageFilter.this.mContext.getResources(), ((Integer) IFImageFilter.this.mResIds.get(4)).intValue());
